    ...
    export default {
        ...
        methods: {
            ...
            checkingOut() {
                ...
                //alert('If this was a production app, you would be taken to a page showing information about how the items will be sent to you. functionality has not been implemented yet.')
